...
VALID_TOTAL_EXP_TIMES = {'amx':{'min':0.005, 'max':300, 'digits':3}, 'fmx':{'min':0.01, 'max':300, 'digits':3}, 'nyx':{'min':0.01, 'max':300, 'digits':3}}
...
#1/13/15 - are these necessary?
    ...
    def createSampleTab(self):
        ...
        self.resolution_ledit.setFixedWidth(80)
        ...
        paramSubspace.setRowMinimumHeight(0, 20) 
        paramSubspace.setRowMinimumHeight(1, 20) 
        paramSubspace.setRowMinimumHeight(2, 20) 
        paramSubspace.setRowMinimumHeight(3, 20) 
        paramSubspace.setRowMinimumHeight(4, 20) 
        ...
        #colStartLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colStartLabel,1,0, alignment=QtCore.Qt.AlignVCenter)
        #self.colEndLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.colEndLabel,2,0, alignment=QtCore.Qt.AlignBottom)
        #colRangeLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colRangeLabel,0,0, alignment=QtCore.Qt.AlignBottom)
        #colExptimeLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colExptimeLabel,3,0, alignment=QtCore.Qt.AlignBottom)
        #totalExptimeLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(totalExptimeLabel,4,0, alignment=QtCore.Qt.AlignBottom)
        # Parameter Collection Column 2, Input Boxes  
        paramSubspace.addWidget(self.osc_range_ledit,0,1, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.osc_start_ledit,1,1, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.osc_end_ledit,2,1, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.exp_time_ledit,3,1, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.totalExptime_ledit,4,1, alignment=QtCore.Qt.AlignBottom)
        # Parameter Collection Column 3, Labels
        paramSubspace.addWidget(detDistLabel,0,2, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colResoLabel,1,2, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colEnergyLabel,2,2, alignment=QtCore.Qt.AlignBottom)
        #colTransmissionLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(colTransmissionLabel,3,2, alignment=QtCore.Qt.AlignBottom)
        #transmisionSPLabel.setAlignment(QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(beamsizeLabel,4,2, alignment=QtCore.Qt.AlignBottom)
        # Parameter Collection Column 4, Input Boxes
        paramSubspace.addWidget(self.detDistMotorEntry.getEntry(),0,3, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.resolution_ledit,1,3, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.energy_ledit,2,3, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.transmission_ledit,3,3, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.beamsizeComboBox,4,3, alignment=QtCore.Qt.AlignBottom)
        # Param Collection Column 5, RBV  
        paramSubspace.addWidget(self.detDistRBVLabel.getEntry(),0,4, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.energyReadback,2,4, alignment=QtCore.Qt.AlignBottom)
        paramSubspace.addWidget(self.transmissionReadback_ledit,3,4, alignment=QtCore.Qt.AlignBottom)
