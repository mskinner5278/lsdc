...
def init_environment():
  ...
  if (beamline == "nyx"):
    ...
    setBlConfig("fastDPNode1", "titania-cpu001")
    setBlConfig("fastDPNode2", "titania-cpu002")
    setBlConfig("fastDPNode3", "titania-cpu003")
    setBlConfig("fastDPNode4", "titania-cpu004")
