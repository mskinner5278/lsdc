...
export PYTHONPATH="/nsls2/data/nyx/shared/config/lsdc_overlay/lsdc-server-2022-3.2.0.1/lib/python3.8/site-packages:.:${CONFIGDIR}:/usr/lib64/edna-mx/mxv1/src:/usr/lib64/edna-mx/kernel/src:${LSDCHOME}:${PROJDIR}/RobotControlLib"
